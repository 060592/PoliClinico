...
{
    public partial class fmConsultaEspecialidad : Form
    {
        //...atributos
        ...
        public fmConsultaEspecialidad(OleDbConnection ConexionBD_)
        {
            InitializeComponent();
            //ConexionBD.Open();
        ...
        private void fmConsultaEspecialidad_Shown(object sender, EventArgs e)
        {
            ProcesarConsulta();
        }
