...
{
    public partial class fmConsultaMedicos : Form
    {
        //...atributos
        ...
        public fmConsultaMedicos(OleDbConnection ConexionBD_)
        {
            InitializeComponent();
            //ConexionBD.Open();
        ...
        private void fmConsultaMedicos_Shown(object sender, EventArgs e)
        {
            ProcesarConsulta();
        }
