...
{
    public partial class fmConsultaPacientes : Form
    {
        //...atributos
        ...
        public fmConsultaPacientes(OleDbConnection ConexionBD_)
        {
            InitializeComponent();
            //ConexionBD.Open();
        ...
        private void fmConsultaPacientes_Shown(object sender, EventArgs e)
        {
            ProcesarConsulta();
        }
